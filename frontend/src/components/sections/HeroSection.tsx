import { Compass, Settings, Shield, ArrowRight } from "lucide-react";
    ...
    <section data-testid="index-hero" className="relative min-h-screen flex flex-col items-center justify-center bg-background overflow-hidden">
      ...
      <div className="container relative z-10 px-4 pt-32 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="text-foreground">Design Your Vision.</span>
            <br />
            <span className="text-primary">Engineer Your Business.</span>
          </motion.h1>
          ...
          >
            A structured approach to help founders move from business idea to scale—without chaos, guesswork, or wrong-stage decisions.
          </motion.p>
