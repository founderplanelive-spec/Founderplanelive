...
import { Target, Cog, ListChecks, TrendingUp, ChevronRight, ChevronDown } from "lucide-react";
...
const steps = [
  {
    ...
    description: "Stop guessing. We use data to pinpoint exactly where your business is right now."
  },
  {
    number: "02",
    icon: Cog,
    title: "Install the Right Engine",
    description: "We connect you to the exact specialized system designed to solve your current bottleneck."
  },
  {
    number: "03",
    icon: ListChecks,
    title: "Execute in Sequence",
    description: "No overlap. No premature scaling. You build exactly what is required for your current stage."
  },
  {
    number: "04",
    icon: TrendingUp,
    title: "Scale with Certainty",
    description: "Move forward with a structured blueprint that scales without making you the fragile center."
  }
];

const PlatformSection = () => {
  return (
    <section id="platform" data-testid="index-platform" className="py-24 md:py-32 bg-gradient-to-b from-slate-50 via-white to-slate-50 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container relative z-10 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold font-display text-slate-900 mb-12">
              The Operating System for <span className="text-primary">Founders</span>
            </h2>
          </motion.div>
          ...
          {/* Blue Bottom Box - The Transition */}
          <motion.div 
          ...
          >
            ...
            <div className="relative z-10 p-10 text-center">
              <p className="text-2xl md:text-3xl font-bold text-white mb-3">
                You cannot engineer growth until you know your stage.
              </p>
              <p className="text-white/80 text-lg mb-4">
                Find your exact coordinates and unlock your blueprint.
              </p>
              <motion.div
                animate={{ y: [0, 6, 0] }}
