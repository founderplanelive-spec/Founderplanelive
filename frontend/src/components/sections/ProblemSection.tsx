...
const painPoints = [
  {
    title: "The Tool & Course Trap:",
    description: "Buying isolated software and generic advice instead of building a unified system."
  },
  {
    title: "Executing Before Clarity:",
    description: "Wasting months—and thousands of dollars—building assets for a direction that hasn't been validated."
  },
  {
    title: "The Founder Bottleneck:",
    description: "Trying to grow before operational infrastructure exists, making you the fragile center of everything."
  }
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-red-600">The Hidden Problem: Stage-Blindness</span>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              {/* Core Argument */}
              <p className="text-primary font-semibold mb-4 text-lg tracking-wide">
              ...
              <p className="text-slate-600 text-lg md:text-xl leading-relaxed mb-10">
                ...
                Without a blueprint, they waste time and capital on the wrong tools, random courses, and mismatched advice.
                When the order is wrong, effort turns into wasted motion.
              </p>
              
              {/* 3 Pain Points with Bold Titles */}
              <div className="space-y-6 mb-10">
                {painPoints.map((point, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-red-50 border border-red-100 flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-red-100 group-hover:border-red-200 transition-all duration-300">
                      <span className="text-red-500 font-bold text-sm">{index + 1}</span>
                    </div>
                    <div>
                      <span className="text-slate-900 font-bold text-lg">{point.title}</span>{" "}
                      <span className="text-slate-600 text-lg leading-relaxed">{point.description}</span>
                    </div>
                  </motion.div>
                ))}
              </div>
              ...
              >
                ...
                <p className="text-white font-semibold text-lg md:text-xl relative z-10 mb-1">
                  This is not a hustle problem. <span className="text-primary">It's a structure problem.</span>
                </p>
                <p className="text-white/70 text-base relative z-10">
                  Finding your exact stage is the only way to fix it.
                </p>
              </motion.div>
            </motion.div>
