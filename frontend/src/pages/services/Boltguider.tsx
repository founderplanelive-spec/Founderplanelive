  ...
  return (
    <>
      <main className="min-h-screen bg-white overflow-x-hidden">
            ...
            <div className="flex items-center gap-4">
              ...
              <motion.div whileHover={{ scale: 1.02, y: -2 }} whileTap={{ scale: 0.98 }}>
                <Button 
                  ...
                  onClick={() => {
                    document.querySelector('[data-testid="boltguider-choice"]')?.scrollIntoView({ behavior: 'smooth' });
                  }}
                >
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
              ...
              >
                ...
                <Button 
                  ...
                  onClick={() => window.open('https://rzp.io/rzp/ViSGzGfM', '_blank')}
                >
                  BOOK STANDARD
                </Button>
              </SpotlightCard>
              ...
              >
                ...
                <motion.button
                  ...
                  onClick={() => window.open('https://rzp.io/rzp/Boltguiderkit', '_blank')}
                >
                  JOIN ACCELERATOR
                  <ArrowRight className="w-4 h-4" />
                </motion.button>
        ...
        <ServiceFooter engineName="BoltGuider" engineIcon={Compass} engineIconBg="bg-blue-100" engineIconColor="text-blue-700" engineBrandColor="#0055FF" />
      </main>
